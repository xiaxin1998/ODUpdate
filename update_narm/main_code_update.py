...
parser.add_argument('--l', type=int, default=12, help='update compression ratio')
...
def main():
    ...
    # model = torch.load("../narm_lastfm_12345_res5_20m_32k_1_pre_l300.pkl")
    teacher1 = torch.load('../narm_gowalla_res1_12345.pkl')
    teacher2 = torch.load('../narm_gowalla_res2_12345.pkl')
    teacher3 = torch.load('../narm_gowalla_res3_12345.pkl')
    teacher4 = torch.load('../narm_gowalla_res4_12345.pkl')
    teacher5 = torch.load('../narm_gowalla_res5_12345.pkl')
    code_model1 = torch.load("../narm_gowalla_12345_res1_20m_32k.pkl")
    code_model2 = torch.load("../narm_gowalla_12345_res2_20m_32k_l8_queue.pkl")
    code_model3 = torch.load("../narm_gowalla_12345_res3_20m_32k_l11_queue.pkl")
    code_model4 = torch.load("../narm_gowalla_12345_res4_20m_32k_l13_queue.pkl")
    # code_model2 = NARMRec(n_node, opt)
    ...
    for epoch in range(200):
        ...
        for K in top_K:
            ...
            if best_results['metric%d' % K][0] < metrics['hit%d' % K]:
                ...
                torch.save(model, "../narm_gowalla_12345_res5_20m_32k_l12_queue.pkl")
